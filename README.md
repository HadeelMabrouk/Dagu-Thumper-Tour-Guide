...
<p align="center">
<img src="https://github.com/HadeelMabrouk/Embedded-Project-2/blob/main/Images/logic2.PNG" width="700" height="400">
<p>
...
* Keil uVision5
* STM32CubeMX
* Serial Bluetooth Terminal (or any equivalent application). 
...
## How to Build and Run
 ...
 Using the serial Bluetooth Terminal application on your Android Mobile Phone, send the following Letters for each mood of operation: <br/>
   "R" : to take the user to the red exhibit. <br/>
   "B" : to take the user to the blue exhibit. <br/>
   "G" : to take the user to the green exhibit. <br/>
   "T" : to take the user in a general tour passing through all the exhibits.  <br/>
...
For the slides, check [this link](https://drive.google.com/file/d/1PBoA8zHhr7vFdGC4cpiVhhmqdndoLiSZ/view?usp=sharing) .
